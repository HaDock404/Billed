...
describe("Given I am connected as an employee", () => {
  ...
  describe('When I am on Bills Page and i click on icon Eye of bill', () => {
    test('Then modal with supporting documents appears', () => {
      ...
      const onNavigate = (pathname) => {//Same as dashboard
      ...
      const html = BillsUI({ data: bills.sort((a, b) => new Date(b.date) - new Date(a.date)) })//we create variable, and in the object BillsUI we sort date for the data bills
      document.body.innerHTML = html //we inject in the page the element sort previously
      ...
      const handleShowModalFile = jest.fn((e) => { billsContainer.handleClickIconEye(e.target) })//Same as Dashboard, simulated function
